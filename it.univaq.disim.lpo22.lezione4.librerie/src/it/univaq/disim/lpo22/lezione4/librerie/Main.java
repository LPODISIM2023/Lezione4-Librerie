...
import static it.univaq.disim.lpo22.lezione4.librerie.business.SupportoNumeriUtil.goldbach;
import static it.univaq.disim.lpo22.lezione4.librerie.business.SupportoNumeriUtil.isPrime;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			int big = 1234567890; 
			float approx = 1234567890; 
			System.out.println(big);
			System.out.println(approx);  
			var marco = new String("Marco");
			var juri = "Marco";
			System.out.println(marco + juri);
